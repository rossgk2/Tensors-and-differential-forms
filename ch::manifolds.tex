...
\label{ch::manifolds::thm::basis_of_TpRn}
    ...
    The directional derivative functions $\Big\{ \frac{\pd}{\pd x^i}\Big|_\pp \Big\}_{i = 1}^n$ form a basis for $T_\pp(\R^n)$.
\end{theorem}
...
\label{ch::manifolds::defn::differential_smooth_function_Rn_Rm}
    ...
    \begin{align*}
        ...
        \frac{\pd \tFF_{(U, \xx), (V, \yy)}}{\pd \xx}\Big|_\pp = \Big( \frac{\pd \tF_{(U, \xx), (V, \yy)}^i}{\pd x^j}\Big|_\pp \Big). \quad \quad \quad \quad \quad \quad
    \end{align*}
\end{defn}
