...
\textbf{TO-DO: use notation $P$ and $P$ for propositions and $P$ and $P(x_1, .., x_n)$ for predicates; analogous to $f$ and $\text{const}$ for constant functions and $f$ and $f(x_1, ..., x_n)$ for functions eval'd on inputs}
