...
\begin{itemize}
    \item prove that if $\ff$ preserves angles (and lengths, if necessary for the conclusion) then $\theta_s(\vv, \ff(\vv))$ is a constant for all $\vv$. this will complete the proof about the standard matrix of a rotation
\end{itemize}
