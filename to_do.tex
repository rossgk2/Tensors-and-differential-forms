...
\begin{itemize}
    ...
    \item Rmk. This type of rotation is sometimes called a proper rotation, as opposed to an improper rotation, which is a function that preserves length, negates signed angle, and fixes the origin.
    \item Thm. If f preserves length and fixes the origin then it is linear.
    ...
    \begin{itemize}
        ...
        \item $\ff$ is linear and preserves dot product
...
\begin{enumerate}
    ...
    \item establish that rotations are isometries, i.e., orthogonal linear functions, and that orthogonal linear functions preserve algebraic dot product. (specifically, the set of rotations is the set of isometries fixing the origin). we need this so we can prove algebraic => geometric. this is mostly outlined.
