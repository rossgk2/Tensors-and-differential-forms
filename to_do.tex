...
Wondering if could do this better, overall. If we have $\ee_1, \ee_2 \in \R^3$ it seems intuitive that we should be able to determine the orientation of $(\ee_1, \ee_2)$ by making use of the standard basis of $\R^3$ somehow.

How about...

$(\ee_1, \ee_2)$ is positively oriented iff $\sproj(\ee_2 \rightarrow \see_2) > 0$, i.e., iff $\ee_2$ is above $\spann(\{\see_2\})$

$(\ee_1, \ee_2, \ee_3)$ is positively oriented iff $\ee_3$ is above $\spann((\ee_1, \ee_2))$

$(\ee_1, ..., \ee_{n - 1}, \ee_n)$ is positively oriented iff $\ee_n$ is above $\spann((\ee_1, ..., \ee_{n - 1}))$
