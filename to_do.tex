...
\begin{itemize}
    ...
    \item Minimize mention of modulus. Here’s the path for doing so. (\textit{Have implemented the below items- still need to check that mention of modulus is actually minimized.})
    \begin{itemize}
