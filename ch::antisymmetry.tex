...
\begin{theorem}
    ...
    There exists a linear function $\widetilde{\ff}:V^{\wedge k} \rightarrow W$ uniquely coorresponding to $\ff$ such that $\ff(\vv_1, ..., \vv_k) = \widetilde{\ff}(\vv_1 \wedge ... \wedge \vv_k)$.
