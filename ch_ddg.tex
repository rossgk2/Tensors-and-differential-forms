...
\begin{lemma}
    ...
    \begin{figure}[H]
        ...
        \caption{The diagram, which is from \cite[p. 110]{book_DDG}, uses $e$ and $e^*$ to denote $e_{ij}$ and $e_{ij}^*$.}
    \end{figure}
