...
%
% Previously, I thought it would be best to define a hyperplane in $n$-dimensions to be a sum of $\pp + W$, where W is an (n - 1)-dimensional subspace. From there we can derive that hyperplanes can be described by implicit equations such as $c_1 x_1 + ... + c_n x_n + b = 0$.
%
% This might be less natural than "a hyperplane is $\pp + \{\ww\}^\perp$ for some $\ww \in V".
%

\begin{comment}
	\subsection*{Implicit to span}
	...
	\subsection*{Span to implicit: example}
	...
	\subsection*{Span to implicit: general theory}
