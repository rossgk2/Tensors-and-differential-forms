...
\begin{defn}
    (Perpendicular vectors in $\R^2$).
    
    We say that $\vv, \ww \in \R^2$ are \textit{perpendicular}, or \textit{orthogonal}, iff $\proj(\vv \rightarrow \ww) = \mathbf{0}$. \textbf{this is circular...}
\end{defn}
