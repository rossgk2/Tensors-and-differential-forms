...
\begin{remark}
    (Unsigned angle as a difference between arbitrary directions).

    Since unsigned angle is the appropriate tool for measuring the angle between arbitrary unit vectors, and as unit vectors correspond to directions (recall Remark \ref{ch::lin_alg::rmk::direction_vectors}), we can view unsigned angle as a means to quantify the difference between arbitrary directions.
\end{remark}
