...
\section*{Planes [reorganize this]}
...
\begin{enumerate}
    ...
    \item Remark. (Using intuition about planes with systems of linear equations). 
  	...
  	A linear equation in $n$ variables is the equation of an $(n - 1)$-dimensional plane, and so a system of $m$ linear equations in $n$ variables can be interpreted to be an intersection of $m$ many $(n - 1)$-dimensional planes.
